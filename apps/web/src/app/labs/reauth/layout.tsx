/**
 * @fileoverview Route metadata for the Reauthentication lab page.
 * @layer app
 *
...
export const metadata: Metadata = {
  title: 'Reauthentication lab',
  description: 'Session revocation and the periodic revalidation counters.',
};
