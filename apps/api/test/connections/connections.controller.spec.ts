 ...
 *       caller user id to the service and acknowledges.
 * Mocks: a ConnectionsService double.
 */
...
describe('ConnectionsController', () => {
  ...
  it('lists connections tagged with the instance', () => {
    ...
    const controller = new ConnectionsController({ list } as unknown as ConnectionsService);
